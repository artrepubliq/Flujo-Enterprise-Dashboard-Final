...
export class ChartsAssignComponent implements OnInit, OnChanges {
  @Input() assign: any;
  ...
  displayChartData(assignCompleted, assignInProgress, assignUnresolved, assignEmail) {
    console.log(JSON.stringify(assignCompleted));
    console.log(assignInProgress);
    console.log(assignUnresolved);
