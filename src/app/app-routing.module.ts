    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'sociallinks', component: SocialLinksComponent, data: { title: 'Social links update' } },
          ...
          { path: 'themeconfiguration', component: ThemeConfigComponent, data: { title: 'Theme Global Config' } },
          ...
          { path: 'chat', component: ChatBoxComponent, data: { title: 'Chat box' } },
          { path: 'user', component: CreateUserComponentComponent, data: { title: 'User Management' } },
          ...
          { path: 'areacategory', component: AreasComponent, data: { title: 'Area Category' } },
          { path: 'termsnconditions', component: TncComponent, data: { title: 'Terms & Conditions' } },
